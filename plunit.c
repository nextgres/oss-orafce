...
**                                                                           **
** ========================================================================= **
**         OPEN-SOURCE IMPLEMENTATION OF THE PL/UNIT TESTING PACKAGE         **
** ========================================================================= **
...
static char *assert_get_message(FunctionCallInfo fcinfo, int nargs,
...
Datum
plunit_assert_true_message (
  PG_FUNCTION_ARGS
) {
  char *message =
    assert_get_message(fcinfo, 2, "plunit.assert_true exception");
...
Datum
plunit_assert_false_message (
  PG_FUNCTION_ARGS
) {
  char *message =
    assert_get_message(fcinfo, 2, "plunit.assert_false exception");
  bool condition = PG_GETARG_BOOL(0);
...
Datum
plunit_assert_null_message (
  PG_FUNCTION_ARGS
) {
  char *message =
    assert_get_message(fcinfo, 2, "plunit.assert_null exception");
...
Datum
plunit_assert_not_null_message (
  PG_FUNCTION_ARGS
) {
  char *message = assert_get_message(fcinfo, 2,
      "plunit.assert_not_null exception");
...
assert_equals_base (
  ...
  return (DatumGetBool(OidFunctionCall2Coll(*ptr, DEFAULT_COLLATION_OID,
         value1, value2)));
} /* assert_equals_base() */
...
plunit_assert_equals_message (
  ...
  char *message =
    assert_get_message(fcinfo, 3, "plunit.assert_equal exception");
...
Datum
plunit_assert_equals_range_message (
  PG_FUNCTION_ARGS
) {
  char *message =
    assert_get_message(fcinfo, 4, "plunit.assert_equal exception");
...
Datum
plunit_assert_not_equals_message (
  PG_FUNCTION_ARGS
) {
  char *message = assert_get_message(fcinfo, 3,
      "plunit.assert_not_equal exception");
...
Datum
plunit_assert_not_equals_range (
  PG_FUNCTION_ARGS
) {
...
Datum
plunit_assert_not_equals_range_message (
  PG_FUNCTION_ARGS
) {
  char *message = assert_get_message(fcinfo, 4,
      "plunit.assert_not_equal exception");
...
plunit_fail_message (
  ...
  char *message =
    assert_get_message(fcinfo, 1, "plunit.assert_fail exception");
