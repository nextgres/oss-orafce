...
**                                                                           **
** ========================================================================= **
**    OPEN SOURCE IMPLEMENTATION OF ORACLE DATABASE BUILT-IN DBMS_ASSERT     **
** ========================================================================= **
...
#define ISNOT_QUALIFIED_SQL_NAME_EXCEPTION() \
  CUSTOM_EXCEPTION(ISNOT_QUALIFIED_SQL_NAME, \
    "string is not qualified SQL name")
...
****************************************************************/
Datum
dbms_assert_qualified_sql_name (
  PG_FUNCTION_ARGS
) {
  text *qname;
