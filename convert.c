...
**                                                                           **
** ========================================================================= **
**    OPEN SOURCE IMPLEMENTATION OF ORACLE DATABASE CONVERSION FUNCTIONS     **
** ========================================================================= **
...
orafce_to_char_numeric (
  ...
  appendStringInfoString(buf,
    DatumGetCString(DirectFunctionCall1(numeric_out, NumericGetDatum(arg0))));
...
orafce_to_number (
  ...
  res =
    DatumGetNumeric(DirectFunctionCall3(numeric_in, CStringGetDatum(
        buf), 0, -1));
